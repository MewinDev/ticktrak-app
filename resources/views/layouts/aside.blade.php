            ...
            <aside
                ...
                <div class="h-full px-3 pb-4 overflow-visible no-scrollbar">
                    ...
                    <ul class="space-y-2 font-medium mt-5 pt-2 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <li>
                            <x-navs.nav-link color="red"
                                href="{{ route('teams.show.leave', strtolower(Str::slug($team->team_name))) }}"
                                :active="Str::contains(request()->url(), '/leave')">
                                <svg class="shrink-0 w-5 h-5 transition duration-75 group-hover:text-red-600 dark:group-hover:text-red-500"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <span class="text-sm ms-3">Leave Group</span>
                            </x-navs.nav-link>
                        </li>
                    </ul>
                </div>
