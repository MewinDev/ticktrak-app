<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <x-forms.text-input color="white" id="email" type="email" name="email" :value="old('email')" required
        ...
        <div class="mt-4">
            ...
            <x-forms.text-input color="white" type="password" name="password" id="password" required
                autocomplete="off" />
        ...
        <div class="flex items-end justify-between mt-4">
            <label for="remember_me" class="group inline-flex">
                <input id="remember_me" type="checkbox"
                    ...
                    name="remember">
                <span
                    class="group-hover:text-white ms-2 text-sm text-gray-600 dark:text-gray-400">{{ __('Remember me') }}</span>
            </label>
