<div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-600 p-5 rounded-md">
    <h2 class="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">Delete Team</h2>
    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Permanently delete this user's team. This action
        cannot be undone.</p>

    <x-forms.button type="button" color="red" extraClass="mt-4" x-data=""
        x-on:click.prevent="$dispatch('open-modal', 'confirm-user-deletion')">{{ __('Delete Team') }}
    </x-forms.button>

    <x-modal title="Delete Team" name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
