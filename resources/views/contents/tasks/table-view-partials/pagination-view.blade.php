        ...
        <template x-for="page in paginationRange()" :key="page">
            <li>
                <button x-text="page" :disabled="page === '...'"
                    ...
                    :class="{
                        'z-10 flex items-center justify-center px-3 py-2 text-sm leading-tight border text-blue-600 bg-blue-50 border-blue-300 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white': page ===
