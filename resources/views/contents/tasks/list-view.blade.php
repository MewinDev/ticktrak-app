...
<template x-if="!loading">
    <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
                        ...
                        <x-slot name="content">
                            <div>
                                <button
                                    ...
                                    Edit
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="2" stroke="currentColor" class="size-5 group-hover:text-blue-500">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <button
                                    @click.prevent="selectedTask = JSON.parse(JSON.stringify(task)); $dispatch('open-modal', 'delete-tasks-modal')"
                                    class="group flex items-center justify-between gap-2 w-full px-4 py-2 text-start text-sm leading-5 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-800 transition duration-150 ease-in-out">
                                    Delete
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="2" stroke="currentColor" class="size-5 group-hover:text-red-500">
                                        <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <!-- Show if no tasks -->
        <div x-show="tasks.length === 0" class="col-span-4 text-center whitespace-nowrap my-10">
