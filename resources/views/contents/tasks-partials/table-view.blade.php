    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            <tr
                ...
                <td class="px-6 py-4">Components</td>
                <td class="px-6 py-4 line-clamp-3">Add Components to Design System</td>
                <td class="px-6 py-4">
                    <span
                        class="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-1.5 rounded-md dark:bg-blue-900 dark:text-blue-300">Low</span>
                </td>
                <td class="px-6 py-4">May 30, 2025</td>
